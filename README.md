...
Administrators or Superusers may manage video library, create booking timeslots, create email templates, send emails to users, mainly in order to provide easy access by providing a token generated by a built in token generator.
...
[Svelte-i18n](https://github.com/pixelmund/svelte-kit-cookie-session#svelte-kit-cookie-session--) - Christian Kaisermann [kaisermann](https://github.com/kaisermann)
